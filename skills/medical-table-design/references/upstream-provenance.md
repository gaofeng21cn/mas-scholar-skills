...
Reviewed method paths: K-Dense scientific-writing/reporting and
scientific-visualization/publication references; Nature `nature-data/SKILL.md`,
`nature-statistics/SKILL.md` and its `references/statistical-reporting.md`.
They inform units, dependence, uncertainty and real data-access statements;
no universal statistical threshold is adopted from them.
