...
- Keep default MAS skill routing single-sourced: writing, review, and figure problems optimize MAS `medical-research-write`, `medical-research-review`, and `medical-research-figure`; MAS Scholar Skills supplies references, packs, quality floors, external-learning absorption, module contracts, and candidate refs for those entries.
