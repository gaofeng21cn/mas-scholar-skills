...
Reviewed method paths: K-Dense `skills/venue-templates/SKILL.md` and the
scientific-writing/reporting references; Nature `nature-data/SKILL.md`,
`nature-response/SKILL.md`, `nature-response/references/intake-and-routing.md`
and `package-consistency-audit.md`. They inform current venue matching,
truthful access declarations and evidence-bound revision actions.
