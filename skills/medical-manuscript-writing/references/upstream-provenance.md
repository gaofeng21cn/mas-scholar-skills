...
Reviewed method paths: K-Dense `skills/scientific-writing/SKILL.md` and
`references/reporting_guidelines.md`; Nature `nature-writing/SKILL.md` and
`nature-shared/core/` introduction, abstract, discussion and main-text references.
They inform study-specific reporting, section-level argument alignment and
preservation of evidence without imposing one journal voice.
