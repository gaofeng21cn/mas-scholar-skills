...
if manifest.get("version") != "0.2.31":
    fail("plugin version must be 0.2.31")
...
if package_manifest.get("version") != "0.2.31":
    fail("capability package version must be 0.2.31")
...
initial_draft_skill_tokens = {
    ...
    "medical-statistical-review": (
        ...
        [
            ...
            "validate_linked_prediction_performance_v2",
            "clinical_assessment",
