...
| 指标 | 数量 |
| --- | ---: |
| Gallery evidence figures | 43 |
| Gallery reporting flow figures | 1 |
| Gallery design figures | 1 |
| Gallery table preview figures | 1 |
| Gallery visual templates | 46 |
| Current canonical templates | 52 |
| Current non-visual canonical inventory | 7 |
| Paper-derived references (explicit only) | 2 |
| Retired alias / duplicate ids | 40 |
| Migration index entries | 94 |
...
| LidocaineQ visual parity audit | /private/tmp/mas-display-gallery-dpcc-boundary/lidocaineq_visual_parity_audit.md |
| LidocaineQ parity contact sheet | /private/tmp/mas-display-gallery-dpcc-boundary/lidocaineq_visual_parity_contact_sheet.png |
| Render cache hit | 0 |
| Render cache miss | 46 |
...
Package-only 打包复用状态：`cleaned_for_force_render`；复制资产数：`0`；更新资产数：`0`。代码、payload、style profile 或 dependency receipt 未变化时，Gallery 可从既有 assets 重打包 HTML/PDF/local gallery markdown outputs；真正的渲染 freshness 仍由 render cache key、layout sidecar、dependency run-context 和真实论文 artifact 审计证明。
...
- publication quality profile coverage: `52/52` (100%)
...
- LidocaineQ 33 项逐图视觉审计: `/private/tmp/mas-display-gallery-dpcc-boundary/lidocaineq_visual_parity_audit.md`
...
| Generalizability | 2 |
| Genomic and Omics | 6 |
| Longitudinal and Patient Trajectory | 2 |
| Matrix Pattern | 5 |
| Model Audit | 1 |
| Model Explanation | 3 |
| Population and Baseline | 5 |
...
| --- | --- | --- |
| `supplementary_adult_sensitivity` | Publication Shells and Tables | table_shell |
| `supplementary_missingness_atlas` | Publication Shells and Tables | table_shell |
| `supplementary_variable_ascertainment` | Publication Shells and Tables | table_shell |
| `table1_baseline_characteristics` | Publication Shells and Tables | table_shell |
| `table4_adult_multidimensional_phenotype` | Publication Shells and Tables | table_shell |
| `table5_xiangya_psychometabolic_profile` | Publication Shells and Tables | table_shell |
| `table6_adult_bmi_waist_central_adiposity` | Publication Shells and Tables | table_shell |
