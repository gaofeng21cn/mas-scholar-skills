...
| Current canonical templates | 54 |
| Current non-visual canonical inventory | 9 |
...
- publication quality profile coverage: `54/54` (100%)
...
| `table2_phenotype_gap_summary` | Publication Shells and Tables | table_shell |
| `table3_transition_site_support_summary` | Publication Shells and Tables | table_shell |
