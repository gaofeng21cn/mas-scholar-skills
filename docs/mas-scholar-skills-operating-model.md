...
MAS Scholar Skills has eight active professional skill-backed capability modules and ten syncable real Codex specialist skills. `medical-figure-style` and `medical-figure-composer` are display subskills under `medical-figure-design`, not additional active modules.
