...
| `medical-figure-style` | style-only visual grammar QA、data fidelity、claim-title truth、excluded-row handling、comparability、label economy、color-vision robustness、final-scale preview 和 export-visible style route-back。 |
| `medical-figure-composer` | compose-only multi-panel outline、existing panel render receipts、panel-letter/gutter/resized-text checks、crop-level consistency、composite review 和 export QA。 |
