...
本轮继续吸收 `K-Dense-AI/scientific-agent-skills` 与 `Yuan1z0825/nature-skills` 的可迁移经验，但落点是真实 Skill 的 AI-first 工作流，不新增并列 stage authority，也不要求先安装外部 runtime。

| Skill | 新增质量要求 |
| --- | --- |
| `medical-figure-design` | figure contract、core conclusion、evidence chain、figure archetype、renderer decision、schematic / infographic evidence boundary、style brief、candidate set、critic review、claimType / graphWarnings claim-drift check、annotation-to-source-regeneration repair hint、final-scale visual QA、style/composition subskill routing 和 reviewer packet。 |
| `medical-figure-style` | style-only visual grammar QA、data fidelity、claim-title truth、excluded-row handling、comparability、label economy、color-vision robustness、final-scale visual QA、annotation-to-source-regeneration repair hint 和 export-visible style route-back。 |
| `medical-figure-composer` | compose-only multi-panel outline、existing panel render receipts、panel-letter/gutter/resized-text checks、crop-level consistency、composite review、final-scale visual QA、annotation-to-source-regeneration route-back 和 export QA。 |
| `medical-manuscript-writing` | one-sentence argument、paper-mission framing、claim/evidence strength calibration、terminology ledger、paragraph job map、section contract、citation integrity、figure/table binding、data/code availability audit。 |
...
各 skill 的新增 judgment refs 是消费提示，不是新 module：Write 负责
