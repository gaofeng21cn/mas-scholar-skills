...
默认 defense 分三段；完整 owner receipt、typed blocker、publication readiness 等边界不在这里重复，统一回到 `docs/no-authority-boundary.md` 和 `contracts/capability_map.json`：
