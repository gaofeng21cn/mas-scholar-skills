...
组学能力在 MAS 形成稳定、可维护、可同步的真实组学专业 workflow 后，再作为新的真实专业 Skill 加入本仓。通用 source / external-learning intake 归 OPL Framework 或 MAS stage/source surface，不在 MAS Scholar Skills 专业 Skill 库或合同中占位。
