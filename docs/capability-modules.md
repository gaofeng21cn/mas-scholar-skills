...
| `medical-research-lit` | PubMed/PMC-first source routing、OPL Connect scientific connector refs consumption、Crossref/OpenAlex metadata / coverage / citation graph fallback refs、query plan、fallback reason、deduplication、retain/reject/watchlist screening、source verification、support-strength matrix、claim-support map、citation integrity floor。 |
