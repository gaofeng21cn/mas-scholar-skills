...
| --- | --- | --- |
| Package | `contracts/opl_capability_package_manifest.json` declares `mas-scholar-skills` version `0.2.18` | Installed resolution and lifecycle currentness require fresh `opl packages` readback |
